defmodule LoanSavingsSystemWeb.Plugs.RequireOfftakerAccess do
  @behaviour Plug
  import Plug.Conn
  ...
  def call(conn, _params) do
    ...
    # with true <- not is_nil(user) && currentUserRole.roleType != "OFFTAKER" do
    #   conn
    #   |> put_flash(:error, "You need to be logged in as an Off-Taker")
