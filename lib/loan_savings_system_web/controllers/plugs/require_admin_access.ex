defmodule LoanSavingsSystemWeb.Plugs.RequireAdminAccess do
  @behaviour Plug
  import Plug.Conn
  ...
  def call(conn, _params) do
    ...
    # with true <- not is_nil(user) && currentUserRole.roleType != "BANKOFFICE_ADMIN" do
    #   conn
    #   |> put_flash(:error, "You need to be logged in as an Admin")
    ...
    with true <- is_nil(currentUserRole) || (!is_nil(currentUserRole) && currentUserRole.roleType != "BANKOFFICE_ADMIN") do
      conn
