defmodule LoanSavingsSystemWeb.Plugs.RequireSmeAccess do
  @behaviour Plug
  import Plug.Conn
  ...
  def call(conn, _params) do
    ...
    # with true <- not is_nil(user) && currentUserRole.roleType != "SME" do
    #   conn
    #   |> put_flash(:error, "You need to be logged in as an SME")
    ...
    with true <- is_nil(currentUserRole) || (!is_nil(currentUserRole) && currentUserRole.roleType != "SME") do
      conn
