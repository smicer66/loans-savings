defmodule LoanSavingsSystemWeb.Plugs.RequireIndividualAccess do
  @behaviour Plug
  import Plug.Conn
  ...
  def call(conn, _params) do
    ...
    # with true <- not is_nil(user) && currentUserRole.roleType != "INDIVIDUAL" do
    #   conn
    #   |> put_flash(:error, "You need to be logged in as an Individual")
    ...
    with true <- is_nil(currentUserRole) || (!is_nil(currentUserRole) && currentUserRole.roleType != "INDIVIDUAL") do
      conn
